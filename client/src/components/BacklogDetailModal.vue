      ...
      <div v-if="isOpen && backlogItem" class="modal-overlay" @click="close">
        <div class="modal-container" @click.stop>
          <div class="modal-header">
            <h3 class="modal-title">{{ t('modals.backlog.title') }}</h3>
          ...
          <div class="modal-body">
            <div class="shortage-header">
              ...
              <span class="priority-badge" :class="backlogItem.priority">
                {{ t('priority.' + backlogItem.priority) }} {{ t('modals.backlog.priority') }}
              </span>
            </div>
...
const formatDate = (dateString) => {
  if (!dateString) return t('modals.backlog.notAvailable')
  const date = new Date(dateString)
  if (isNaN(date.getTime())) return t('modals.backlog.notAvailable')
